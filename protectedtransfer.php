...
if ($_POST) {
    if (!isset($_POST["token"]) || $_POST["token"] !== $_SESSION["form_token"]) {
        $hata = "Güvenlik doğrulaması başarısız oldu.";
    } else {
...
<head>
    ...
    <title>CSRF Protected Page</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="container">
    <div class="box">
        ...
        <div class="bilgipaneli">
            ...
            <div class="bilgi_satir">
                <span class="bilgi_etiket">🛡 CSRF Protected</span>
                <span class="bilgi_deger">Aktif (Token)</span>
            </div>
        </div>
    </div>
